...
CAYENNE_OUT_DEFAULT()
{
  ...
  Cayenne.virtualWrite(4, String(Temp_F).c_str());
  Cayenne.virtualWrite(5, String(Temp_K).c_str());
  //DHT11
  ...
  Cayenne.virtualWrite(6, String(temperature + 273.15).c_str());
  Cayenne.virtualWrite(7, String((temperature * 1.8) + 32).c_str());
